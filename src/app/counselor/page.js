      ...
      <section className="py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8">
        <div className="container mx-auto">
          <div className="grid gap-6 sm:gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
            <div className="rounded-[12px] bg-white p-4 sm:p-6 transition duration-300 hover:shadow-lg hover:scale-[1.02] transform " style={{ boxShadow: 'rgba(100, 100, 111, 0.26) 0px 7px 29px 0px' }}>
            ...
            <div className="rounded-[12px] bg-white p-4 sm:p-6 transition-all duration-300 transform hover:shadow-lg hover:scale-[1.02]" style={{ boxShadow: 'rgba(100, 100, 111, 0.26) 0px 7px 29px 0px' }}>
              <div className="mb-3 sm:mb-4">
